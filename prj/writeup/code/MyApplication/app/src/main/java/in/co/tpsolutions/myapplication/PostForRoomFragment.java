 ...
 */
public class PostForRoomFragment extends Fragment {
    ...
    RadioButton radio_gender_b, radio_m_stat_b, radio_food_habit_b, radio_cooking_skills_b, radio_u_r_a_b, radio_smoker_b, radio_alcho_b;
    EditText phone_no, occupation, city, country, nationality, message;
    Button submit;


    public PostForRoomFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_post_for_room, container, false);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String phone_no1, occupation1, city1, gender1, country1, nationality1, message1, m_stat1, cooking1, foodhab1, ura1, smoker1,
                        alcho1,type_of_occu1, type_of_house1, no_of_rooms1, age1, no_of_roommates1, rent_budget1;
    ...
    private void uploadData(final String primary_key1,final String phone_no2,final String gender2, final String occupation2,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_POST_FOR_ROOM, new Response.Listener<String>() {
