 ...
 */
public class PostForTenantFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_post_for_tenant, container, false);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                no_of_rooms1 ="2";// spinner_no_of_rooms.getSelectedItem().toString();
    ...
    private void uploadData(final String primary_key1,final String phone_no2,final String gender2, final String occupation2,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.URL_POST_FOR_TENANT, new Response.Listener<String>() {
